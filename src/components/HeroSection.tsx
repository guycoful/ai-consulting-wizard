        ...
        <div className="relative mb-6 md:mb-8">
          ...
          <div className="md:hidden mb-4 px-4">
            <Button 
              ...
              size="lg"
              className="bg-white text-blue-primary hover:bg-gray-100 font-heebo font-medium px-8 py-4 text-lg w-full transition-all duration-300 hover:scale-105 shadow-lg animate-glow-pulse hover:animate-none"
            >
              מלא טופס איפיון
            </Button>
          </div>
          ...
          <div className="hidden md:block mb-6">
            <Button 
              onClick={handleFormNavigation}
              size="lg"
              className="bg-white text-blue-primary hover:bg-gray-100 font-heebo font-medium px-8 py-4 text-lg transition-all duration-300 hover:scale-105 shadow-lg animate-glow-pulse hover:animate-none"
            >
              מלא טופס איפיון
            </Button>
          </div>
