const TestimonialsSection = () => {
  return (
    <section id="testimonials" className="bg-navy-light py-16 md:py-20">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[1, 2, 3].map((index) => (
            <div key={index} className="bg-navy-dark p-8 rounded-xl border-2 border-dashed border-gold relative">
              ...
              <div className="text-center">
                ...
                <p className="text-lg text-gray-300 font-heebo italic mb-4">
                  המלצת לקוח תתווסף כאן בקרוב...
                </p>
                <div className="h-px bg-gold w-12 mx-auto mb-2"></div>
                <p className="text-sm text-gray-300 font-heebo">
                  שם הלקוח
                </p>
              </div>
            </div>
