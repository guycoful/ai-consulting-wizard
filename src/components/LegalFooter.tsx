        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-sm font-heebo">
              ...
              <a href="https://www.linkedin.com/in/guycohen-ai/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors">
