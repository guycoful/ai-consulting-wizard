      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
          <div className="flex-shrink-0">
            <div className="w-48 h-48 md:w-56 md:h-56 rounded-full bg-gray-700 flex items-center justify-center overflow-hidden shadow-lg border-4 border-gold">
              <img 
          ...
          <div className="flex-1 text-center md:text-right">
            ...
            <p className="text-lg text-gray-300 font-heebo leading-relaxed mb-8">
