...
### פרסונה: גיא כהן
- **סגנון**: "חבר שמבין ב-AI" — לא יועץ רשמי בחליפה, אלא בחור שיושב איתך בבית קפה ופותר לך בעיה
- **מראה**: קז'ואל-מקצועי — חולצה מכופתרת בלי עניבה, נגיש ואנושי
- **פנייה**: "אתה/את" בשיחה ישירה עם ליד, "אתם" בפוסטים לקהילה
- **טון**: ישיר, חם, עם הומור קל ואימוג'ים. כמו הודעת וואטסאפ לחבר, לא מכתב רשמי
- **כלל ברזל**: "כתוב כאילו מסביר לבן משפחה שלא בתחום" — אף פעם ז'רגון טכני

### קהל יעד
- בעלי עסקים קטנים, גיל 30-55, ישראלים
- רובם לא טכניים — יודעים ש-AI קיים אבל לא מאיפה להתחיל
- מגיעים מלינקדאין, וואטסאפ ופייסבוק
- ~70% מובייל — חוויית מובייל קודמת!

### לוגו
- נוכחי: "גיא כהן | AI" — טקסט בלבד (זמני)
- כיוון עתידי: סמל מינימליסטי GC + אלמנט AI (ניצוץ/כוכב)
