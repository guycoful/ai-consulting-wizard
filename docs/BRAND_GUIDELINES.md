...
- **כלל ברזל (אתר + פייסבוק)**: "כתוב כאילו מסביר לבן משפחה שלא בתחום" — אף פעם ז'רגון טכני
- **חריגה מותרת (לינקדאין)**: הקהל בלינקדאין (מפתחים, יועצי AI, אנשי אוטומציה) דווקא רוצה לראות את ה"איך" — ארכיטקטורה, פרומפטים, סיסטם. מותר "גידור סמנטי" (כמו "דאטה מת", "כשל מערכתי", API) אך תמיד להנגיש — למשל "חיבור API = צינור שמעביר מידע בין שני כלים"
...
**לינקדאין (B2B + קהילה מקצועית):**
- מפתחים, יועצי AI, אנשי אוטומציה, מקדמי אתרים
- רוצים לראות את ה"איך" — ארכיטקטורה, פרומפטים, תהליכים
- מעדיפים תוכן אנליטי עם ROI ומספרים
- תמונות לאורך (Vertical) לתפוס שטח מסך ולהגדיל Dwell Time

### התאמת תוכן לפלטפורמה

| פלטפורמה | מה לשתף | טון | ז'רגון |
|-----------|---------|-----|--------|
| **לינקדאין** | ה"איך" — פרומפט, ארכיטקטורה, סיסטם | אנליטי + כנות (Candor) | מותר עם הנגשה |
| **פייסבוק** | ה"מה" — סוכן מוכן, תוצאה, דמו | חברי, נגיש, בלי ז'רגון | אסור |
| **אתר** | שניהם — מאמרים מקצועיים + FAQ פשוט | "חבר שמבין ב-AI" | מינימלי |
| **וואטסאפ** | ערך מיידי — טיפים, כלים, סוכנים חינמיים | ישיר, אישי, אימוג'ים | אסור |

### צ'קליסט טרום-פרסום לינקדאין
- [ ] הוק חזק ואנליטי (שורה ראשונה שתופסת)
- [ ] ערכי מותג (מציג תוצאות/מספרים/הוכחות)?
- [ ] CTA ברור (הנעה לתגובה — "כתוב X ואשלח")?
- [ ] מבנה 1:3:1 (שורה פתיחה, 3 שורות גוף, שורה סיכום)?
- [ ] תמונה לאורך בפלטת Navy + Purple + Heebo?
- [ ] נאמן לזהות: "פותר בעיה בבית קפה" ולא "יועץ רשמי"?

### לוגו
- נוכחי: "גיא כהן | AI" — טקסט בלבד (זמני)
- כיוון עתידי: סמל מינימליסטי GC + אלמנט AI (ניצוץ/כוכב)
- חותמת על כל תמונה בלינקדאין — ברגע שהלוגו מוכן

### שימוש בפלטת הצבעים בתוכן חיצוני
- קרוסלות / אינפוגרפיקות / הדמיות בלינקדאין: **רק** Navy Dark + Navy Light לרקעים, Purple 700 לאקצנטים
- **רק** גופן Heebo על תמונות וקרוסלות — זיהוי מותגי מיידי בפיד
- באנר לינקדאין: לכלול הצעת ערך + סלוגן בשפה הויזואלית של האתר
